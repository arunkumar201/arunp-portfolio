...
export default function Contact() {
	return (
		<>
			<div className="flex flex-col p-5 items-center m-auto md:px-[40px] px-4 border-2 border-blue rounded-lg mb-20 tracking-wide leading-7">
				<h1 className="mb-5 text-3xl font-bold text-center">Get in Touch</h1>
				<h1 className="mb-5 text-xl leading-8 tracking-wider text-center text-gray-200">
					...
					say hello, feel free to drop me a line. Open to new job opportunities,
					I'm eager to hear from you if my skills align with your needs. Don't
