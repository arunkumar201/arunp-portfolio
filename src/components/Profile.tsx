...
const Profile = (props: Props) => {
	return (
		<div className="w-full h-full px-2 py-4">
			<div className="relative block w-full mb-5 after:content group after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight">
				<Image
